# PROMPT: NotebookLM Batch 01 Extraction (Domain Foundations)
...
## Research Questions
1. **Stakeholder Dynamics**: Who are the primary actors in a BaaS ecosystem? What are their roles and responsibilities?
2. **"As-Is" Manual Logic**: How do traditional systems handle multi-party reconciliation or funds movement manually?
3. **Entropy & Pain Points**: What specific risks (operational, regulatory, or technical) are identified in distributed financial chains?
4. **First Principles**: What are the "Non-negotiable" rules of a ledger mentioned (e.g., Double-entry rules, ISO 20022)?
