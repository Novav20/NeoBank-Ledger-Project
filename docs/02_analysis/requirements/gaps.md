...
| Traceability granularity for NFRs | Story metadata already references NFR identifiers, but the BPA NFR registry has not yet been split into dedicated NFR files, so those links are not yet concrete file targets. | Open |
